...
require_relative "media_get_response_kind"
require_relative "media_get_response_files_item"
require "date"
require "ostruct"
require "json"
...
module Ittybit
  class Media
    class MediaGetResponse
      ...
      # @return [String]
      attr_reader :object
      # @return [Ittybit::Media::MediaGetResponseKind]
      attr_reader :kind
      # @return [String]
      attr_reader :title
      # @return [String]
      ...
      # @return [Array<Ittybit::Media::MediaGetResponseFilesItem>]
      attr_reader :files
      ...
      # @param id [String]
      # @param object [String]
      # @param kind [Ittybit::Media::MediaGetResponseKind]
      # @param title [String]
      # @param alt [String]
      # @param width [Integer]
      # @param height [Integer]
      # @param duration [Float]
      # @param files [Array<Ittybit::Media::MediaGetResponseFilesItem>]
      ...
      def self.from_json(json_object:)
        ...
        files = parsed_json["files"]&.map do |item|
          item = item.to_json
          Ittybit::Media::MediaGetResponseFilesItem.from_json(json_object: item)
        end
      ...
      def self.validate_raw(obj:)
        ...
        obj.kind&.is_a?(Ittybit::Media::MediaGetResponseKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
