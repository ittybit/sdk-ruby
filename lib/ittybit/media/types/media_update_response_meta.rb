...
require_relative "media_update_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Media
    class MediaUpdateResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Media::MediaUpdateResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Media::MediaUpdateResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of MediaUpdateResponseMeta
      #
      ...
      # Serialize an instance of MediaUpdateResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Media::MediaUpdateResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
