...
require_relative "media_create_response_data_files_item_object"
require_relative "media_create_response_data_files_item_kind"
require_relative "media_create_response_data_files_item_orientation"
require "date"
require_relative "media_create_response_data_files_item_status"
require "ostruct"
require "json"

module Ittybit
  class Media
    class MediaCreateResponseDataFilesItem
      # @return [String]
      attr_reader :id
      # @return [Ittybit::Media::MediaCreateResponseDataFilesItemObject]
      attr_reader :object
      # @return [Ittybit::Media::MediaCreateResponseDataFilesItemKind]
      attr_reader :kind
      # @return [String]
      attr_reader :type
      # @return [String]
      ...
      # @return [Integer]
      attr_reader :height
      # @return [Ittybit::Media::MediaCreateResponseDataFilesItemOrientation]
      ...
      # @return [DateTime]
      attr_reader :updated
      # @return [Ittybit::Media::MediaCreateResponseDataFilesItemStatus]
      attr_reader :status
      ...
      # @param id [String]
      # @param object [Ittybit::Media::MediaCreateResponseDataFilesItemObject]
      # @param kind [Ittybit::Media::MediaCreateResponseDataFilesItemKind]
      # @param type [String]
      # @param codec [String]
      # @param container [String]
      # @param width [Integer]
      # @param height [Integer]
      # @param orientation [Ittybit::Media::MediaCreateResponseDataFilesItemOrientation]
      ...
      # @param status [Ittybit::Media::MediaCreateResponseDataFilesItemStatus]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Ittybit::Media::MediaCreateResponseDataFilesItem]
      ...
      # Deserialize a JSON object to an instance of MediaCreateResponseDataFilesItem
      #
      ...
      # Serialize an instance of MediaCreateResponseDataFilesItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.object.is_a?(Ittybit::Media::MediaCreateResponseDataFilesItemObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
        obj.kind.is_a?(Ittybit::Media::MediaCreateResponseDataFilesItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.orientation&.is_a?(Ittybit::Media::MediaCreateResponseDataFilesItemOrientation) != false || raise("Passed value for field obj.orientation is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Media::MediaCreateResponseDataFilesItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      end
    end
  end
end
