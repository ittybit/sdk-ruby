...
module Ittybit
  class Media
    class MediaDeleteResponseLinks
      # @return [String]
      attr_reader :self_
      # @return [String]
      attr_reader :parent
      ...
      # Deserialize a JSON object to an instance of MediaDeleteResponseLinks
      #
      ...
      # Serialize an instance of MediaDeleteResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
