...
require_relative "media_create_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Media
    class MediaCreateResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Media::MediaCreateResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Media::MediaCreateResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of MediaCreateResponseMeta
      #
      ...
      # Serialize an instance of MediaCreateResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Media::MediaCreateResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
