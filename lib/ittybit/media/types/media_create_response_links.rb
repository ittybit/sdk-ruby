...
module Ittybit
  class Media
    class MediaCreateResponseLinks
      # @return [String]
      attr_reader :self_
      # @return [String]
      attr_reader :parent
      ...
      # Deserialize a JSON object to an instance of MediaCreateResponseLinks
      #
      ...
      # Serialize an instance of MediaCreateResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
