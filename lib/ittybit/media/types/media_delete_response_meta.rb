...
require_relative "media_delete_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Media
    class MediaDeleteResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Media::MediaDeleteResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Media::MediaDeleteResponseMetaType]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Ittybit::Media::MediaDeleteResponseMeta]
      ...
      # Deserialize a JSON object to an instance of MediaDeleteResponseMeta
      #
      ...
      # Serialize an instance of MediaDeleteResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Media::MediaDeleteResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
