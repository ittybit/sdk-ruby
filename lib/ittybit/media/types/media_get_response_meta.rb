...
require_relative "media_get_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Media
    class MediaGetResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Media::MediaGetResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Media::MediaGetResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of MediaGetResponseMeta
      #
      ...
      # Serialize an instance of MediaGetResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Media::MediaGetResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
