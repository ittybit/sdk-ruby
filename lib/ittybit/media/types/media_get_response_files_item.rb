...
require_relative "media_get_response_files_item_object"
require_relative "media_get_response_files_item_kind"
require_relative "media_get_response_files_item_orientation"
require "date"
require_relative "media_get_response_files_item_status"
require "ostruct"
require "json"

module Ittybit
  class Media
    class MediaGetResponseFilesItem
      # @return [String]
      attr_reader :id
      # @return [Ittybit::Media::MediaGetResponseFilesItemObject]
      attr_reader :object
      # @return [Ittybit::Media::MediaGetResponseFilesItemKind]
      attr_reader :kind
      # @return [String]
      attr_reader :type
      # @return [String]
      ...
      # @return [Integer]
      attr_reader :height
      # @return [Ittybit::Media::MediaGetResponseFilesItemOrientation]
      ...
      # @return [DateTime]
      attr_reader :updated
      # @return [Ittybit::Media::MediaGetResponseFilesItemStatus]
      attr_reader :status
      ...
      # @param id [String]
      # @param object [Ittybit::Media::MediaGetResponseFilesItemObject]
      # @param kind [Ittybit::Media::MediaGetResponseFilesItemKind]
      # @param type [String]
      # @param codec [String]
      # @param container [String]
      # @param width [Integer]
      # @param height [Integer]
      # @param orientation [Ittybit::Media::MediaGetResponseFilesItemOrientation]
      ...
      # @param status [Ittybit::Media::MediaGetResponseFilesItemStatus]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Ittybit::Media::MediaGetResponseFilesItem]
      ...
      # Deserialize a JSON object to an instance of MediaGetResponseFilesItem
      #
      ...
      # Serialize an instance of MediaGetResponseFilesItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.object.is_a?(Ittybit::Media::MediaGetResponseFilesItemObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
        obj.kind.is_a?(Ittybit::Media::MediaGetResponseFilesItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.orientation&.is_a?(Ittybit::Media::MediaGetResponseFilesItemOrientation) != false || raise("Passed value for field obj.orientation is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Media::MediaGetResponseFilesItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      end
    end
  end
end
