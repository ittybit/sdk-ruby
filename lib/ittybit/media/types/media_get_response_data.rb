...
require_relative "media_get_response_data_kind"
require_relative "media_get_response_data_files_item"
require "date"
require "ostruct"
require "json"
...
module Ittybit
  class Media
    class MediaGetResponseData
      # @return [String]
      attr_reader :id
      # @return [String]
      attr_reader :object
      # @return [Ittybit::Media::MediaGetResponseDataKind]
      attr_reader :kind
      # @return [String]
      attr_reader :title
      # @return [String]
      ...
      # @return [Array<Ittybit::Media::MediaGetResponseDataFilesItem>]
      attr_reader :files
      ...
      # @param id [String]
      # @param object [String]
      # @param kind [Ittybit::Media::MediaGetResponseDataKind]
      # @param title [String]
      # @param alt [String]
      # @param width [Integer]
      # @param height [Integer]
      # @param duration [Float]
      # @param files [Array<Ittybit::Media::MediaGetResponseDataFilesItem>]
      ...
      # Deserialize a JSON object to an instance of MediaGetResponseData
      #
      ...
      def self.from_json(json_object:)
        ...
        files = parsed_json["files"]&.map do |item|
          item = item.to_json
          Ittybit::Media::MediaGetResponseDataFilesItem.from_json(json_object: item)
        end
      ...
      # Serialize an instance of MediaGetResponseData to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.kind&.is_a?(Ittybit::Media::MediaGetResponseDataKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
