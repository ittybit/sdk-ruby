...
module Ittybit
  class Media
    class MediaGetResponseLinks
      ...
      # Deserialize a JSON object to an instance of MediaGetResponseLinks
      #
      ...
      # Serialize an instance of MediaGetResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
