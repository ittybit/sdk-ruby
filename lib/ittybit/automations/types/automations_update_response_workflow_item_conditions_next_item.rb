...
module Ittybit
  class Automations
    class AutomationsUpdateResponseWorkflowItemConditionsNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsUpdateResponseWorkflowItemConditionsNextItem]
      ...
      # Serialize an instance of AutomationsUpdateResponseWorkflowItemConditionsNextItem
      #  to a JSON object
      #
      # @return [String]
      def to_json(*_args)
