...
module Ittybit
  class Automations
    class AutomationsGetResponseWorkflowItemConditionsNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsGetResponseWorkflowItemConditionsNextItem]
      ...
      #  AutomationsGetResponseWorkflowItemConditionsNextItem
      #
      ...
      # Serialize an instance of AutomationsGetResponseWorkflowItemConditionsNextItem to
      #  a JSON object
      #
      # @return [String]
      def to_json(*_args)
