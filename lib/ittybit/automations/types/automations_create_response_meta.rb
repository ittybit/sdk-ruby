...
require_relative "automations_create_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Automations
    class AutomationsCreateResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Automations::AutomationsCreateResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Automations::AutomationsCreateResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of AutomationsCreateResponseMeta
      #
      ...
      # Serialize an instance of AutomationsCreateResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Automations::AutomationsCreateResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
