...
module Ittybit
  class Automations
    class AutomationsListResponseItemWorkflowItemRefNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsListResponseItemWorkflowItemRefNextItem]
      ...
      #  AutomationsListResponseItemWorkflowItemRefNextItem
      #
      ...
      # Serialize an instance of AutomationsListResponseItemWorkflowItemRefNextItem to a
      #  JSON object
      #
      # @return [String]
      def to_json(*_args)
