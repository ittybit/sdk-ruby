...
module Ittybit
  class Automations
    class AutomationsGetResponseWorkflowItemRefNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsGetResponseWorkflowItemRefNextItem]
      ...
      #  AutomationsGetResponseWorkflowItemRefNextItem
      #
      ...
      # Serialize an instance of AutomationsGetResponseWorkflowItemRefNextItem to a JSON
      #  object
      #
      # @return [String]
      def to_json(*_args)
