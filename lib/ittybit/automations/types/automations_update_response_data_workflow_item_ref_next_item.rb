...
module Ittybit
  class Automations
    class AutomationsUpdateResponseDataWorkflowItemRefNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsUpdateResponseDataWorkflowItemRefNextItem]
      ...
      #  AutomationsUpdateResponseDataWorkflowItemRefNextItem
      #
      ...
      # Serialize an instance of AutomationsUpdateResponseDataWorkflowItemRefNextItem to
      #  a JSON object
      #
      # @return [String]
      def to_json(*_args)
