...
module Ittybit
  class Automations
    class AutomationsGetResponseTrigger
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :event
      ...
      # Deserialize a JSON object to an instance of AutomationsGetResponseTrigger
      #
      ...
      # Serialize an instance of AutomationsGetResponseTrigger to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
