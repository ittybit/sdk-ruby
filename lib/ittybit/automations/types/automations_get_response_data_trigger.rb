...
module Ittybit
  class Automations
    class AutomationsGetResponseDataTrigger
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :event
      ...
      # Deserialize a JSON object to an instance of AutomationsGetResponseDataTrigger
      #
      ...
      # Serialize an instance of AutomationsGetResponseDataTrigger to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
