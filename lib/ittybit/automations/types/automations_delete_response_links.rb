...
module Ittybit
  class Automations
    class AutomationsDeleteResponseLinks
      # @return [String]
      attr_reader :self_
      # @return [String]
      attr_reader :parent
      ...
      # Deserialize a JSON object to an instance of AutomationsDeleteResponseLinks
      #
      ...
      # Serialize an instance of AutomationsDeleteResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
