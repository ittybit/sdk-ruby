...
require_relative "automations_delete_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Automations
    class AutomationsDeleteResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Automations::AutomationsDeleteResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Automations::AutomationsDeleteResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of AutomationsDeleteResponseMeta
      #
      ...
      # Serialize an instance of AutomationsDeleteResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Automations::AutomationsDeleteResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
