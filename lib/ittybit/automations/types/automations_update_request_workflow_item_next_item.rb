...
module Ittybit
  class Automations
    class AutomationsUpdateRequestWorkflowItemNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsUpdateRequestWorkflowItemNextItem]
      ...
      #  AutomationsUpdateRequestWorkflowItemNextItem
      #
      ...
      # Serialize an instance of AutomationsUpdateRequestWorkflowItemNextItem to a JSON
      #  object
      #
      # @return [String]
      def to_json(*_args)
