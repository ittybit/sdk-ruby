...
module Ittybit
  class Automations
    class AutomationsCreateResponseTrigger
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :event
      ...
      # Deserialize a JSON object to an instance of AutomationsCreateResponseTrigger
      #
      ...
      # Serialize an instance of AutomationsCreateResponseTrigger to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
