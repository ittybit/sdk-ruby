...
module Ittybit
  class Automations
    class AutomationsGetResponseDataWorkflowItemConditionsNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsGetResponseDataWorkflowItemConditionsNextItem]
      ...
      #  AutomationsGetResponseDataWorkflowItemConditionsNextItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
