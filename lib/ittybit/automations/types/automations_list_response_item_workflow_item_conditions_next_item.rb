...
module Ittybit
  class Automations
    class AutomationsListResponseItemWorkflowItemConditionsNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsListResponseItemWorkflowItemConditionsNextItem]
      ...
      #  AutomationsListResponseItemWorkflowItemConditionsNextItem
      #
      ...
      #  AutomationsListResponseItemWorkflowItemConditionsNextItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
