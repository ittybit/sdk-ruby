...
module Ittybit
  class Automations
    class AutomationsCreateResponseWorkflowItemConditionsNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsCreateResponseWorkflowItemConditionsNextItem]
      ...
      # Serialize an instance of AutomationsCreateResponseWorkflowItemConditionsNextItem
      #  to a JSON object
      #
      # @return [String]
      def to_json(*_args)
