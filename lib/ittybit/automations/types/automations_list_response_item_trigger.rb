...
module Ittybit
  class Automations
    class AutomationsListResponseItemTrigger
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :event
      ...
      # Deserialize a JSON object to an instance of AutomationsListResponseItemTrigger
      #
      ...
      # Serialize an instance of AutomationsListResponseItemTrigger to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
