...
module Ittybit
  class Automations
    class AutomationsCreateResponseWorkflowItemRefNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsCreateResponseWorkflowItemRefNextItem]
      ...
      #  AutomationsCreateResponseWorkflowItemRefNextItem
      #
      ...
      # Serialize an instance of AutomationsCreateResponseWorkflowItemRefNextItem to a
      #  JSON object
      #
      # @return [String]
      def to_json(*_args)
