...
module Ittybit
  class Automations
    class AutomationsGetResponseDataWorkflowItemRefNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsGetResponseDataWorkflowItemRefNextItem]
      ...
      #  AutomationsGetResponseDataWorkflowItemRefNextItem
      #
      ...
      # Serialize an instance of AutomationsGetResponseDataWorkflowItemRefNextItem to a
      #  JSON object
      #
      # @return [String]
      def to_json(*_args)
