...
module Ittybit
  class Automations
    class AutomationsListResponseDataItemTrigger
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :event
      ...
      #  AutomationsListResponseDataItemTrigger
      #
      ...
      # Serialize an instance of AutomationsListResponseDataItemTrigger to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
