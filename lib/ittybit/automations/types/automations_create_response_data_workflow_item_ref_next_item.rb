...
module Ittybit
  class Automations
    class AutomationsCreateResponseDataWorkflowItemRefNextItem
      # @return [String]
      attr_reader :kind
      # @return [String]
      attr_reader :ref
      ...
      # @return [Ittybit::Automations::AutomationsCreateResponseDataWorkflowItemRefNextItem]
      ...
      # Serialize an instance of AutomationsCreateResponseDataWorkflowItemRefNextItem to
      #  a JSON object
      #
      # @return [String]
      def to_json(*_args)
