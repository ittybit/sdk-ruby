...
module Ittybit
  class Signatures
    class SignaturesCreateResponseLinks
      # @return [String]
      attr_reader :self_
      # @return [String]
      attr_reader :parent
      ...
      # Deserialize a JSON object to an instance of SignaturesCreateResponseLinks
      #
      ...
      # Serialize an instance of SignaturesCreateResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
