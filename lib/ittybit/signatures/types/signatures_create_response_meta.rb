...
require_relative "signatures_create_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Signatures
    class SignaturesCreateResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Signatures::SignaturesCreateResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Signatures::SignaturesCreateResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of SignaturesCreateResponseMeta
      #
      ...
      # Serialize an instance of SignaturesCreateResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Signatures::SignaturesCreateResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
