...
require_relative "files_create_response_data_object"
require_relative "files_create_response_data_kind"
require "date"
require_relative "files_create_response_data_status"
require "ostruct"
require "json"

module Ittybit
  class Files
    class FilesCreateResponseData
      # @return [String]
      attr_reader :id
      # @return [String]
      attr_reader :media_id
      # @return [Ittybit::Files::FilesCreateResponseDataObject]
      attr_reader :object
      # @return [Ittybit::Files::FilesCreateResponseDataKind]
      attr_reader :kind
      # @return [String]
      attr_reader :type
      # @return [String]
      ...
      # @return [DateTime]
      attr_reader :updated
      # @return [Ittybit::Files::FilesCreateResponseDataStatus]
      attr_reader :status
      ...
      # @param object [Ittybit::Files::FilesCreateResponseDataObject]
      # @param kind [Ittybit::Files::FilesCreateResponseDataKind]
      # @param type [String]
      # @param codec [String]
      ...
      # @param status [Ittybit::Files::FilesCreateResponseDataStatus]
      ...
      # Deserialize a JSON object to an instance of FilesCreateResponseData
      #
      ...
      # Serialize an instance of FilesCreateResponseData to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.object.is_a?(Ittybit::Files::FilesCreateResponseDataObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
        obj.kind.is_a?(Ittybit::Files::FilesCreateResponseDataKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Files::FilesCreateResponseDataStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      end
    end
  end
end
