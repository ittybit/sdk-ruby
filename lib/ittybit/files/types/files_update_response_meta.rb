...
require_relative "files_update_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Files
    class FilesUpdateResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Files::FilesUpdateResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Files::FilesUpdateResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of FilesUpdateResponseMeta
      #
      ...
      # Serialize an instance of FilesUpdateResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Files::FilesUpdateResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
