...
module Ittybit
  class Files
    class FilesListResponseLinks
      ...
      # Deserialize a JSON object to an instance of FilesListResponseLinks
      #
      ...
      # Serialize an instance of FilesListResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
