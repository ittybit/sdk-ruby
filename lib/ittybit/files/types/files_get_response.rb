...
require_relative "files_get_response_object"
require_relative "files_get_response_kind"
require "date"
require_relative "files_get_response_status"
require "ostruct"
require "json"
...
module Ittybit
  class Files
    class FilesGetResponse
      ...
      # @return [Ittybit::Files::FilesGetResponseObject]
      attr_reader :object
      # @return [Ittybit::Files::FilesGetResponseKind]
      attr_reader :kind
      # @return [String]
      attr_reader :type
      # @return [String]
      ...
      # @return [DateTime]
      attr_reader :updated
      # @return [Ittybit::Files::FilesGetResponseStatus]
      attr_reader :status
      ...
      # @param object [Ittybit::Files::FilesGetResponseObject]
      # @param kind [Ittybit::Files::FilesGetResponseKind]
      # @param type [String]
      # @param codec [String]
      ...
      # @param status [Ittybit::Files::FilesGetResponseStatus]
