...
require_relative "files_update_response_object"
require_relative "files_update_response_kind"
require "date"
require_relative "files_update_response_status"
require "ostruct"
require "json"
...
module Ittybit
  class Files
    class FilesUpdateResponse
      ...
      # @return [Ittybit::Files::FilesUpdateResponseObject]
      attr_reader :object
      # @return [Ittybit::Files::FilesUpdateResponseKind]
      attr_reader :kind
      # @return [String]
      attr_reader :type
      # @return [String]
      ...
      # @return [DateTime]
      attr_reader :updated
      # @return [Ittybit::Files::FilesUpdateResponseStatus]
      attr_reader :status
      ...
      # @param object [Ittybit::Files::FilesUpdateResponseObject]
      # @param kind [Ittybit::Files::FilesUpdateResponseKind]
      # @param type [String]
      # @param codec [String]
      ...
      # @param status [Ittybit::Files::FilesUpdateResponseStatus]
      ...
      def self.validate_raw(obj:)
        ...
        obj.object.is_a?(Ittybit::Files::FilesUpdateResponseObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
        obj.kind.is_a?(Ittybit::Files::FilesUpdateResponseKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Files::FilesUpdateResponseStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      end
    end
  end
end
