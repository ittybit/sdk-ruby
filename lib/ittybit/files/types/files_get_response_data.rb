...
require_relative "files_get_response_data_object"
require_relative "files_get_response_data_kind"
require "date"
require_relative "files_get_response_data_status"
require "ostruct"
require "json"

module Ittybit
  class Files
    class FilesGetResponseData
      # @return [String]
      attr_reader :id
      # @return [String]
      attr_reader :media_id
      # @return [Ittybit::Files::FilesGetResponseDataObject]
      attr_reader :object
      # @return [Ittybit::Files::FilesGetResponseDataKind]
      attr_reader :kind
      # @return [String]
      attr_reader :type
      # @return [String]
      ...
      # @return [DateTime]
      attr_reader :updated
      # @return [Ittybit::Files::FilesGetResponseDataStatus]
      attr_reader :status
      ...
      # @param object [Ittybit::Files::FilesGetResponseDataObject]
      # @param kind [Ittybit::Files::FilesGetResponseDataKind]
      # @param type [String]
      # @param codec [String]
      ...
      # @param status [Ittybit::Files::FilesGetResponseDataStatus]
      ...
      # Deserialize a JSON object to an instance of FilesGetResponseData
      #
      ...
      # Serialize an instance of FilesGetResponseData to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.object.is_a?(Ittybit::Files::FilesGetResponseDataObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
        obj.kind.is_a?(Ittybit::Files::FilesGetResponseDataKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Files::FilesGetResponseDataStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      end
    end
  end
end
