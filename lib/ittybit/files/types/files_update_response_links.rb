...
module Ittybit
  class Files
    class FilesUpdateResponseLinks
      # @return [String]
      attr_reader :self_
      # @return [String]
      attr_reader :parent
      ...
      # Deserialize a JSON object to an instance of FilesUpdateResponseLinks
      #
      ...
      # Serialize an instance of FilesUpdateResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
