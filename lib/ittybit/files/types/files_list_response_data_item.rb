...
require_relative "files_list_response_data_item_object"
require_relative "files_list_response_data_item_kind"
require "date"
require_relative "files_list_response_data_item_status"
require "ostruct"
require "json"

module Ittybit
  class Files
    class FilesListResponseDataItem
      # @return [String]
      attr_reader :id
      # @return [String]
      attr_reader :media_id
      # @return [Ittybit::Files::FilesListResponseDataItemObject]
      attr_reader :object
      # @return [Ittybit::Files::FilesListResponseDataItemKind]
      attr_reader :kind
      # @return [String]
      attr_reader :type
      # @return [String]
      ...
      # @return [DateTime]
      attr_reader :updated
      # @return [Ittybit::Files::FilesListResponseDataItemStatus]
      attr_reader :status
      ...
      # @param object [Ittybit::Files::FilesListResponseDataItemObject]
      # @param kind [Ittybit::Files::FilesListResponseDataItemKind]
      # @param type [String]
      # @param codec [String]
      ...
      # @param status [Ittybit::Files::FilesListResponseDataItemStatus]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Ittybit::Files::FilesListResponseDataItem]
      ...
      # Deserialize a JSON object to an instance of FilesListResponseDataItem
      #
      ...
      # Serialize an instance of FilesListResponseDataItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.object.is_a?(Ittybit::Files::FilesListResponseDataItemObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
        obj.kind.is_a?(Ittybit::Files::FilesListResponseDataItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Files::FilesListResponseDataItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      end
    end
  end
end
