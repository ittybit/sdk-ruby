...
module Ittybit
  class Files
    class FilesDeleteResponseLinks
      # @return [String]
      attr_reader :self_
      # @return [String]
      attr_reader :parent
      ...
      # Deserialize a JSON object to an instance of FilesDeleteResponseLinks
      #
      ...
      # Serialize an instance of FilesDeleteResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
