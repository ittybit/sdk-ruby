...
module Ittybit
  class Files
    class FilesGetResponseLinks
      ...
      # Deserialize a JSON object to an instance of FilesGetResponseLinks
      #
      ...
      # Serialize an instance of FilesGetResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
