...
require_relative "files_delete_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Files
    class FilesDeleteResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Files::FilesDeleteResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Files::FilesDeleteResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of FilesDeleteResponseMeta
      #
      ...
      # Serialize an instance of FilesDeleteResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Files::FilesDeleteResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
