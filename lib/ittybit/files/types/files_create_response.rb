...
require_relative "files_create_response_object"
require_relative "files_create_response_kind"
require "date"
require_relative "files_create_response_status"
require "ostruct"
require "json"
...
module Ittybit
  class Files
    class FilesCreateResponse
      ...
      # @return [Ittybit::Files::FilesCreateResponseObject]
      attr_reader :object
      # @return [Ittybit::Files::FilesCreateResponseKind]
      attr_reader :kind
      # @return [String]
      attr_reader :type
      # @return [String]
      ...
      # @return [DateTime]
      attr_reader :updated
      # @return [Ittybit::Files::FilesCreateResponseStatus]
      attr_reader :status
      ...
      # @param object [Ittybit::Files::FilesCreateResponseObject]
      # @param kind [Ittybit::Files::FilesCreateResponseKind]
      # @param type [String]
      # @param codec [String]
      ...
      # @param status [Ittybit::Files::FilesCreateResponseStatus]
      ...
      def self.validate_raw(obj:)
        ...
        obj.object.is_a?(Ittybit::Files::FilesCreateResponseObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
        obj.kind.is_a?(Ittybit::Files::FilesCreateResponseKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Files::FilesCreateResponseStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      end
    end
  end
end
