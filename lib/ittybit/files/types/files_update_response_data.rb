...
require_relative "files_update_response_data_object"
require_relative "files_update_response_data_kind"
require "date"
require_relative "files_update_response_data_status"
require "ostruct"
require "json"

module Ittybit
  class Files
    class FilesUpdateResponseData
      # @return [String]
      attr_reader :id
      # @return [String]
      attr_reader :media_id
      # @return [Ittybit::Files::FilesUpdateResponseDataObject]
      attr_reader :object
      # @return [Ittybit::Files::FilesUpdateResponseDataKind]
      attr_reader :kind
      # @return [String]
      attr_reader :type
      # @return [String]
      ...
      # @return [DateTime]
      attr_reader :updated
      # @return [Ittybit::Files::FilesUpdateResponseDataStatus]
      attr_reader :status
      ...
      # @param object [Ittybit::Files::FilesUpdateResponseDataObject]
      # @param kind [Ittybit::Files::FilesUpdateResponseDataKind]
      # @param type [String]
      # @param codec [String]
      ...
      # @param status [Ittybit::Files::FilesUpdateResponseDataStatus]
      ...
      # Deserialize a JSON object to an instance of FilesUpdateResponseData
      #
      ...
      # Serialize an instance of FilesUpdateResponseData to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.object.is_a?(Ittybit::Files::FilesUpdateResponseDataObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
        obj.kind.is_a?(Ittybit::Files::FilesUpdateResponseDataKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Files::FilesUpdateResponseDataStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      end
    end
  end
end
