...
require_relative "files_get_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Files
    class FilesGetResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Files::FilesGetResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Files::FilesGetResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of FilesGetResponseMeta
      #
      ...
      # Serialize an instance of FilesGetResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Files::FilesGetResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
