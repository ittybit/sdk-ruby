...
module Ittybit
  class Files
    class FilesCreateResponseLinks
      # @return [String]
      attr_reader :self_
      # @return [String]
      attr_reader :parent
      ...
      # Deserialize a JSON object to an instance of FilesCreateResponseLinks
      #
      ...
      # Serialize an instance of FilesCreateResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
