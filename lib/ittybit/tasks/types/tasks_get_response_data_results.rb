...
module Ittybit
  class Tasks
    class TasksGetResponseDataResults
      ...
      # Deserialize a JSON object to an instance of TasksGetResponseDataResults
      #
      ...
      # Serialize an instance of TasksGetResponseDataResults to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
