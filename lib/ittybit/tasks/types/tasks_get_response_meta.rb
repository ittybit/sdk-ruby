...
require_relative "tasks_get_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Tasks
    class TasksGetResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Tasks::TasksGetResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Tasks::TasksGetResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of TasksGetResponseMeta
      #
      ...
      # Serialize an instance of TasksGetResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Tasks::TasksGetResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
