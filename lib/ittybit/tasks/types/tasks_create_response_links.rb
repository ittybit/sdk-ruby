...
module Ittybit
  class Tasks
    class TasksCreateResponseLinks
      # @return [String]
      attr_reader :self_
      # @return [String]
      attr_reader :parent
      ...
      # Deserialize a JSON object to an instance of TasksCreateResponseLinks
      #
      ...
      # Serialize an instance of TasksCreateResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
