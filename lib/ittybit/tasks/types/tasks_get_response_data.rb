...
require_relative "tasks_get_response_data_kind"
require_relative "tasks_get_response_data_status"
require "date"
require_relative "tasks_get_response_data_results"
require "ostruct"
require "json"

module Ittybit
  class Tasks
    class TasksGetResponseData
      # @return [String]
      attr_reader :id
      # @return [String]
      attr_reader :object
      # @return [Ittybit::Tasks::TasksGetResponseDataKind]
      attr_reader :kind
      ...
      # @return [Hash{String => Object}]
      attr_reader :output
      # @return [Ittybit::Tasks::TasksGetResponseDataStatus]
      attr_reader :status
      # @return [Integer]
      ...
      # @return [Ittybit::Tasks::TasksGetResponseDataResults]
      attr_reader :results
      ...
      # @param id [String]
      # @param object [String]
      # @param kind [Ittybit::Tasks::TasksGetResponseDataKind]
      # @param input [Hash{String => Object}]
      # @param options [Hash{String => Object}]
      # @param output [Hash{String => Object}]
      # @param status [Ittybit::Tasks::TasksGetResponseDataStatus]
      ...
      # @param results [Ittybit::Tasks::TasksGetResponseDataResults]
      ...
      # Deserialize a JSON object to an instance of TasksGetResponseData
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["results"].nil?
          ...
          results = Ittybit::Tasks::TasksGetResponseDataResults.from_json(json_object: results)
        end
        new(
          id: id,
          object: object,
      ...
      # Serialize an instance of TasksGetResponseData to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.kind.is_a?(Ittybit::Tasks::TasksGetResponseDataKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Tasks::TasksGetResponseDataStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
        ...
        obj.results.nil? || Ittybit::Tasks::TasksGetResponseDataResults.validate_raw(obj: obj.results)
      end
    end
  end
end
