...
module Ittybit
  class Tasks
    class TasksListResponseDataItemResults
      ...
      # Deserialize a JSON object to an instance of TasksListResponseDataItemResults
      #
      ...
      # Serialize an instance of TasksListResponseDataItemResults to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
