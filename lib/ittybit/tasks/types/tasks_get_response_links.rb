...
module Ittybit
  class Tasks
    class TasksGetResponseLinks
      ...
      # Deserialize a JSON object to an instance of TasksGetResponseLinks
      #
      ...
      # Serialize an instance of TasksGetResponseLinks to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
