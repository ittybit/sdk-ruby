...
module Ittybit
  class Tasks
    class TasksCreateResponseDataResults
      ...
      # Deserialize a JSON object to an instance of TasksCreateResponseDataResults
      #
      ...
      # Serialize an instance of TasksCreateResponseDataResults to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
