...
require_relative "tasks_list_response_item_kind"
require_relative "tasks_list_response_item_status"
require "date"
require_relative "tasks_list_response_item_results"
require "ostruct"
require "json"

module Ittybit
  class Tasks
    class TasksListResponseItem
      # @return [String]
      attr_reader :id
      # @return [String]
      attr_reader :object
      # @return [Ittybit::Tasks::TasksListResponseItemKind]
      attr_reader :kind
      ...
      # @return [Hash{String => Object}]
      attr_reader :output
      # @return [Ittybit::Tasks::TasksListResponseItemStatus]
      attr_reader :status
      # @return [Integer]
      ...
      # @return [Ittybit::Tasks::TasksListResponseItemResults]
      attr_reader :results
      ...
      # @param id [String]
      # @param object [String]
      # @param kind [Ittybit::Tasks::TasksListResponseItemKind]
      # @param input [Hash{String => Object}]
      # @param options [Hash{String => Object}]
      # @param output [Hash{String => Object}]
      # @param status [Ittybit::Tasks::TasksListResponseItemStatus]
      ...
      # @param results [Ittybit::Tasks::TasksListResponseItemResults]
      # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
      # @return [Ittybit::Tasks::TasksListResponseItem]
      ...
      # Deserialize a JSON object to an instance of TasksListResponseItem
      #
      ...
      def self.from_json(json_object:)
        ...
        if parsed_json["results"].nil?
          ...
          results = Ittybit::Tasks::TasksListResponseItemResults.from_json(json_object: results)
        end
        new(
          id: id,
          object: object,
      ...
      # Serialize an instance of TasksListResponseItem to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.kind.is_a?(Ittybit::Tasks::TasksListResponseItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
        ...
        obj.status.is_a?(Ittybit::Tasks::TasksListResponseItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
        ...
        obj.results.nil? || Ittybit::Tasks::TasksListResponseItemResults.validate_raw(obj: obj.results)
      end
    end
  end
end
