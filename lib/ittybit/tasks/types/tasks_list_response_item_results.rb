...
module Ittybit
  class Tasks
    class TasksListResponseItemResults
      ...
      # Deserialize a JSON object to an instance of TasksListResponseItemResults
      #
      ...
      # Serialize an instance of TasksListResponseItemResults to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
