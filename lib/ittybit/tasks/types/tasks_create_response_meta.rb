...
require_relative "tasks_create_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class Tasks
    class TasksCreateResponseMeta
      # @return [String]
      ...
      # @return [String]
      attr_reader :version
      # @return [Ittybit::Tasks::TasksCreateResponseMetaType]
      attr_reader :type
      ...
      # @param type [Ittybit::Tasks::TasksCreateResponseMetaType]
      ...
      # Deserialize a JSON object to an instance of TasksCreateResponseMeta
      #
      ...
      # Serialize an instance of TasksCreateResponseMeta to a JSON object
      #
      # @return [String]
      def to_json(*_args)
        @_field_set&.to_json
      ...
      def self.validate_raw(obj:)
        ...
        obj.type&.is_a?(Ittybit::Tasks::TasksCreateResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
      end
    end
  end
end
