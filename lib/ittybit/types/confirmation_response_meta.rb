...
require_relative "confirmation_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class ConfirmationResponseMeta
    # @return [String]
    ...
    # @return [String]
    attr_reader :version
    # @return [Ittybit::ConfirmationResponseMetaType]
    attr_reader :type
    ...
    # @param type [Ittybit::ConfirmationResponseMetaType]
    ...
    # Deserialize a JSON object to an instance of ConfirmationResponseMeta
    #
    ...
    # Serialize an instance of ConfirmationResponseMeta to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(Ittybit::ConfirmationResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
    end
  end
end
