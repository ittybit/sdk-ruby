...
require_relative "media_response_data_files_item_object"
require_relative "media_response_data_files_item_kind"
require_relative "media_response_data_files_item_orientation"
require "date"
require_relative "media_response_data_files_item_status"
require "ostruct"
require "json"

module Ittybit
  class MediaResponseDataFilesItem
    # @return [String]
    attr_reader :id
    # @return [Ittybit::MediaResponseDataFilesItemObject]
    attr_reader :object
    # @return [Ittybit::MediaResponseDataFilesItemKind]
    attr_reader :kind
    # @return [String]
    attr_reader :type
    # @return [String]
    ...
    # @return [Integer]
    attr_reader :height
    # @return [Ittybit::MediaResponseDataFilesItemOrientation]
    ...
    # @return [DateTime]
    attr_reader :updated
    # @return [Ittybit::MediaResponseDataFilesItemStatus]
    attr_reader :status
    ...
    # @param id [String]
    # @param object [Ittybit::MediaResponseDataFilesItemObject]
    # @param kind [Ittybit::MediaResponseDataFilesItemKind]
    # @param type [String]
    # @param codec [String]
    # @param container [String]
    # @param width [Integer]
    # @param height [Integer]
    # @param orientation [Ittybit::MediaResponseDataFilesItemOrientation]
    ...
    # @param status [Ittybit::MediaResponseDataFilesItemStatus]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Ittybit::MediaResponseDataFilesItem]
    ...
    # Deserialize a JSON object to an instance of MediaResponseDataFilesItem
    #
    ...
    # Serialize an instance of MediaResponseDataFilesItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.is_a?(Ittybit::MediaResponseDataFilesItemObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
      obj.kind.is_a?(Ittybit::MediaResponseDataFilesItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.orientation&.is_a?(Ittybit::MediaResponseDataFilesItemOrientation) != false || raise("Passed value for field obj.orientation is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::MediaResponseDataFilesItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end
