...
module Ittybit
  class AutomationResponseLinks
    ...
    # Deserialize a JSON object to an instance of AutomationResponseLinks
    #
    ...
    # Serialize an instance of AutomationResponseLinks to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
