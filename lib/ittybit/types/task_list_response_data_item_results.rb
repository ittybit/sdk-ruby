...
module Ittybit
  class TaskListResponseDataItemResults
    ...
    # Deserialize a JSON object to an instance of TaskListResponseDataItemResults
    #
    ...
    # Serialize an instance of TaskListResponseDataItemResults to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
