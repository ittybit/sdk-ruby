...
module Ittybit
  class AutomationListResponseDataItemWorkflowItemConditionsConditionsItem
    # @return [String]
    attr_reader :prop
    # @return [String]
    attr_reader :value
    ...
    # @return [Ittybit::AutomationListResponseDataItemWorkflowItemConditionsConditionsItem]
    ...
    #  AutomationListResponseDataItemWorkflowItemConditionsConditionsItem to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
