...
require_relative "task_response_data_kind"
require_relative "task_response_data_status"
require "date"
require_relative "task_response_data_results"
require "ostruct"
require "json"
...
module Ittybit
  class TaskResponseData
    ...
    # @return [String]
    attr_reader :object
    # @return [Ittybit::TaskResponseDataKind]
    attr_reader :kind
    ...
    # @return [Hash{String => Object}]
    attr_reader :output
    # @return [Ittybit::TaskResponseDataStatus]
    attr_reader :status
    # @return [Integer]
    ...
    # @return [Ittybit::TaskResponseDataResults]
    attr_reader :results
    ...
    # @param results [Ittybit::TaskResponseDataResults]
    ...
    # Deserialize a JSON object to an instance of TaskResponseData
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["results"].nil?
        ...
        results = Ittybit::TaskResponseDataResults.from_json(json_object: results)
      end
      new(
        id: id,
        object: object,
    ...
    # Serialize an instance of TaskResponseData to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.kind.is_a?(Ittybit::TaskResponseDataKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::TaskResponseDataStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.results.nil? || Ittybit::TaskResponseDataResults.validate_raw(obj: obj.results)
    end
  end
end
