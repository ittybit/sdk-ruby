...
module Ittybit
  class AutomationWorkflowItemRefNextItem
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :ref
    ...
    # @return [Ittybit::AutomationWorkflowItemRefNextItem]
    ...
    # Deserialize a JSON object to an instance of AutomationWorkflowItemRefNextItem
    #
    ...
    # Serialize an instance of AutomationWorkflowItemRefNextItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
