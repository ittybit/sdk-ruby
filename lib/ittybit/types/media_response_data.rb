...
require_relative "media_response_data_kind"
require_relative "media_response_data_files_item"
require "date"
require "ostruct"
require "json"
...
module Ittybit
  class MediaResponseData
    ...
    # @return [String]
    attr_reader :object
    # @return [Ittybit::MediaResponseDataKind]
    attr_reader :kind
    # @return [String]
    attr_reader :title
    # @return [String]
    ...
    # @return [Array<Ittybit::MediaResponseDataFilesItem>]
    attr_reader :files
    ...
    # @param id [String]
    # @param object [String]
    # @param kind [Ittybit::MediaResponseDataKind]
    # @param title [String]
    # @param alt [String]
    # @param width [Integer]
    # @param height [Integer]
    # @param duration [Float]
    # @param files [Array<Ittybit::MediaResponseDataFilesItem>]
    ...
    # Deserialize a JSON object to an instance of MediaResponseData
    #
    ...
    def self.from_json(json_object:)
      ...
      files = parsed_json["files"]&.map do |item|
        item = item.to_json
        Ittybit::MediaResponseDataFilesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of MediaResponseData to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.kind&.is_a?(Ittybit::MediaResponseDataKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
