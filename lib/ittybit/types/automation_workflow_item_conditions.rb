...
require_relative "automation_workflow_item_conditions_conditions_item"
require_relative "automation_workflow_item_conditions_next_item"
require "ostruct"
require "json"

module Ittybit
  class AutomationWorkflowItemConditions
    # @return [String]
    attr_reader :kind
    # @return [Array<Ittybit::AutomationWorkflowItemConditionsConditionsItem>]
    attr_reader :conditions
    # @return [Array<Ittybit::AutomationWorkflowItemConditionsNextItem>]
    attr_reader :next_
    ...
    # @param kind [String]
    # @param conditions [Array<Ittybit::AutomationWorkflowItemConditionsConditionsItem>]
    # @param next_ [Array<Ittybit::AutomationWorkflowItemConditionsNextItem>]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Ittybit::AutomationWorkflowItemConditions]
    ...
    def self.from_json(json_object:)
      ...
      conditions = parsed_json["conditions"]&.map do |item|
        item = item.to_json
        Ittybit::AutomationWorkflowItemConditionsConditionsItem.from_json(json_object: item)
      end
      next_ = parsed_json["next"]&.map do |item|
        item = item.to_json
        Ittybit::AutomationWorkflowItemConditionsNextItem.from_json(json_object: item)
      end
      new(
        kind: kind,
        conditions: conditions,
