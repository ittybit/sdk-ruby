...
module Ittybit
  class TaskResponseDataResults
    ...
    # Deserialize a JSON object to an instance of TaskResponseDataResults
    #
    ...
    # Serialize an instance of TaskResponseDataResults to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
