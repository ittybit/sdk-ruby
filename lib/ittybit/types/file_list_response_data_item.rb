...
require_relative "file_list_response_data_item_object"
require_relative "file_list_response_data_item_kind"
require "date"
require_relative "file_list_response_data_item_status"
require "ostruct"
require "json"

module Ittybit
  class FileListResponseDataItem
    # @return [String]
    attr_reader :id
    # @return [String]
    attr_reader :media_id
    # @return [Ittybit::FileListResponseDataItemObject]
    attr_reader :object
    # @return [Ittybit::FileListResponseDataItemKind]
    attr_reader :kind
    # @return [String]
    attr_reader :type
    # @return [String]
    ...
    # @return [DateTime]
    attr_reader :updated
    # @return [Ittybit::FileListResponseDataItemStatus]
    attr_reader :status
    ...
    # @param object [Ittybit::FileListResponseDataItemObject]
    # @param kind [Ittybit::FileListResponseDataItemKind]
    # @param type [String]
    # @param codec [String]
    ...
    # @param status [Ittybit::FileListResponseDataItemStatus]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Ittybit::FileListResponseDataItem]
    ...
    # Deserialize a JSON object to an instance of FileListResponseDataItem
    #
    ...
    # Serialize an instance of FileListResponseDataItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.is_a?(Ittybit::FileListResponseDataItemObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
      obj.kind.is_a?(Ittybit::FileListResponseDataItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::FileListResponseDataItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end
