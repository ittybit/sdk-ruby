...
module Ittybit
  class MediaListResponseLinks
    ...
    # Deserialize a JSON object to an instance of MediaListResponseLinks
    #
    ...
    # Serialize an instance of MediaListResponseLinks to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
