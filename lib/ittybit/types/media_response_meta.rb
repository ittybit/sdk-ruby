...
require_relative "media_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class MediaResponseMeta
    # @return [String]
    ...
    # @return [String]
    attr_reader :version
    # @return [Ittybit::MediaResponseMetaType]
    attr_reader :type
    ...
    # @param type [Ittybit::MediaResponseMetaType]
    ...
    # Deserialize a JSON object to an instance of MediaResponseMeta
    #
    ...
    # Serialize an instance of MediaResponseMeta to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(Ittybit::MediaResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
    end
  end
end
