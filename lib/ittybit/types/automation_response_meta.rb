...
require_relative "automation_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class AutomationResponseMeta
    # @return [String]
    ...
    # @return [String]
    attr_reader :version
    # @return [Ittybit::AutomationResponseMetaType]
    attr_reader :type
    ...
    # @param type [Ittybit::AutomationResponseMetaType]
    ...
    # Deserialize a JSON object to an instance of AutomationResponseMeta
    #
    ...
    # Serialize an instance of AutomationResponseMeta to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(Ittybit::AutomationResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
    end
  end
end
