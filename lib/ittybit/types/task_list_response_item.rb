...
require_relative "task_list_response_item_kind"
require_relative "task_list_response_item_status"
require "date"
require_relative "task_list_response_item_results"
require "ostruct"
require "json"
...
module Ittybit
  class TaskListResponseItem
    ...
    # @return [String]
    attr_reader :object
    # @return [Ittybit::TaskListResponseItemKind]
    attr_reader :kind
    ...
    # @return [Hash{String => Object}]
    attr_reader :output
    # @return [Ittybit::TaskListResponseItemStatus]
    attr_reader :status
    # @return [Integer]
    ...
    # @param results [Ittybit::TaskListResponseItemResults]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Ittybit::TaskListResponseItem]
    ...
    # Deserialize a JSON object to an instance of TaskListResponseItem
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["results"].nil?
        ...
        results = Ittybit::TaskListResponseItemResults.from_json(json_object: results)
      end
      new(
        id: id,
        object: object,
    ...
    # Serialize an instance of TaskListResponseItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.kind.is_a?(Ittybit::TaskListResponseItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::TaskListResponseItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.results.nil? || Ittybit::TaskListResponseItemResults.validate_raw(obj: obj.results)
    end
  end
end
