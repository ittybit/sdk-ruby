...
module Ittybit
  class AutomationResponseWorkflowItemConditionsNextItem
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :ref
    ...
    # @return [Ittybit::AutomationResponseWorkflowItemConditionsNextItem]
    ...
    #  AutomationResponseWorkflowItemConditionsNextItem
    #
    ...
    # Serialize an instance of AutomationResponseWorkflowItemConditionsNextItem to a
    #  JSON object
    #
    # @return [String]
    def to_json(*_args)
