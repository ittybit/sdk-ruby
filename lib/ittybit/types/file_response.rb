...
require_relative "file_response_object"
require_relative "file_response_kind"
require "date"
require_relative "file_response_status"
require "ostruct"
require "json"
...
module Ittybit
  class FileResponse
    ...
    # @return [Ittybit::FileResponseObject]
    attr_reader :object
    # @return [Ittybit::FileResponseKind]
    attr_reader :kind
    # @return [String]
    attr_reader :type
    # @return [String]
    ...
    # @return [DateTime]
    attr_reader :updated
    # @return [Ittybit::FileResponseStatus]
    attr_reader :status
    ...
    # @param object [Ittybit::FileResponseObject]
    # @param kind [Ittybit::FileResponseKind]
    # @param type [String]
    # @param codec [String]
    ...
    # @param status [Ittybit::FileResponseStatus]
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.is_a?(Ittybit::FileResponseObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
      obj.kind.is_a?(Ittybit::FileResponseKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::FileResponseStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end
