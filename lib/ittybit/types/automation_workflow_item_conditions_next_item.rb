...
module Ittybit
  class AutomationWorkflowItemConditionsNextItem
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :ref
    ...
    # @return [Ittybit::AutomationWorkflowItemConditionsNextItem]
    ...
    #  AutomationWorkflowItemConditionsNextItem
    #
    ...
    # Serialize an instance of AutomationWorkflowItemConditionsNextItem to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
