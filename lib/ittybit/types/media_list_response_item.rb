...
require_relative "media_list_response_item_kind"
require_relative "media_list_response_item_files_item"
require "date"
require "ostruct"
require "json"

module Ittybit
  class MediaListResponseItem
    # @return [String]
    attr_reader :id
    # @return [String]
    attr_reader :object
    # @return [Ittybit::MediaListResponseItemKind]
    attr_reader :kind
    # @return [String]
    attr_reader :title
    # @return [String]
    ...
    # @return [Array<Ittybit::MediaListResponseItemFilesItem>]
    attr_reader :files
    ...
    # @param id [String]
    # @param object [String]
    # @param kind [Ittybit::MediaListResponseItemKind]
    # @param title [String]
    # @param alt [String]
    # @param width [Integer]
    # @param height [Integer]
    # @param duration [Float]
    # @param files [Array<Ittybit::MediaListResponseItemFilesItem>]
    ...
    # @return [Ittybit::MediaListResponseItem]
    ...
    # Deserialize a JSON object to an instance of MediaListResponseItem
    #
    ...
    def self.from_json(json_object:)
      ...
      files = parsed_json["files"]&.map do |item|
        item = item.to_json
        Ittybit::MediaListResponseItemFilesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of MediaListResponseItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.kind&.is_a?(Ittybit::MediaListResponseItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
