...
module Ittybit
  class SignatureResponseLinks
    ...
    # Deserialize a JSON object to an instance of SignatureResponseLinks
    #
    ...
    # Serialize an instance of SignatureResponseLinks to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
