...
require_relative "file_list_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class FileListResponseMeta
    # @return [String]
    ...
    # @return [String]
    attr_reader :version
    # @return [Ittybit::FileListResponseMetaType]
    attr_reader :type
    # @return [Integer]
    attr_reader :limit
    # @return [Integer]
    ...
    # @param type [Ittybit::FileListResponseMetaType]
    # @param limit [Integer]
    # @param total [Integer]
    # @param page [Integer]
    # @param pages [Integer]
    ...
    # Deserialize a JSON object to an instance of FileListResponseMeta
    #
    ...
    # Serialize an instance of FileListResponseMeta to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(Ittybit::FileListResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
