...
module Ittybit
  class AutomationResponseDataTrigger
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :event
    ...
    # Deserialize a JSON object to an instance of AutomationResponseDataTrigger
    #
    ...
    # Serialize an instance of AutomationResponseDataTrigger to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
