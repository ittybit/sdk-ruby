...
module Ittybit
  class AutomationResponseDataWorkflowItemConditionsNextItem
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :ref
    ...
    # @return [Ittybit::AutomationResponseDataWorkflowItemConditionsNextItem]
    ...
    # Serialize an instance of AutomationResponseDataWorkflowItemConditionsNextItem to
    #  a JSON object
    #
    # @return [String]
    def to_json(*_args)
