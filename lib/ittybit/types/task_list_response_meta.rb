...
require_relative "task_list_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class TaskListResponseMeta
    # @return [String]
    ...
    # @return [String]
    attr_reader :version
    # @return [Ittybit::TaskListResponseMetaType]
    attr_reader :type
    # @return [Integer]
    attr_reader :limit
    # @return [Integer]
    ...
    # @param type [Ittybit::TaskListResponseMetaType]
    # @param limit [Integer]
    # @param total [Integer]
    # @param page [Integer]
    # @param pages [Integer]
    ...
    # Deserialize a JSON object to an instance of TaskListResponseMeta
    #
    ...
    # Serialize an instance of TaskListResponseMeta to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(Ittybit::TaskListResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
