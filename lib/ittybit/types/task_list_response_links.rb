...
module Ittybit
  class TaskListResponseLinks
    ...
    # Deserialize a JSON object to an instance of TaskListResponseLinks
    #
    ...
    # Serialize an instance of TaskListResponseLinks to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
