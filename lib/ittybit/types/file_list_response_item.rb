...
require_relative "file_list_response_item_object"
require_relative "file_list_response_item_kind"
require "date"
require_relative "file_list_response_item_status"
require "ostruct"
require "json"
...
module Ittybit
  class FileListResponseItem
    ...
    # @return [Ittybit::FileListResponseItemObject]
    attr_reader :object
    # @return [Ittybit::FileListResponseItemKind]
    attr_reader :kind
    # @return [String]
    attr_reader :type
    # @return [String]
    ...
    # @return [DateTime]
    attr_reader :updated
    # @return [Ittybit::FileListResponseItemStatus]
    attr_reader :status
    ...
    # @param object [Ittybit::FileListResponseItemObject]
    # @param kind [Ittybit::FileListResponseItemKind]
    # @param type [String]
    # @param codec [String]
    ...
    # @param status [Ittybit::FileListResponseItemStatus]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Ittybit::FileListResponseItem]
    ...
    # Deserialize a JSON object to an instance of FileListResponseItem
    #
    ...
    # Serialize an instance of FileListResponseItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.is_a?(Ittybit::FileListResponseItemObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
      obj.kind.is_a?(Ittybit::FileListResponseItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::FileListResponseItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end
