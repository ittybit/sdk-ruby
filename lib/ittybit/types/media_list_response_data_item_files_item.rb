...
require_relative "media_list_response_data_item_files_item_object"
require_relative "media_list_response_data_item_files_item_kind"
require_relative "media_list_response_data_item_files_item_orientation"
require "date"
require_relative "media_list_response_data_item_files_item_status"
require "ostruct"
require "json"

module Ittybit
  class MediaListResponseDataItemFilesItem
    # @return [String]
    attr_reader :id
    # @return [Ittybit::MediaListResponseDataItemFilesItemObject]
    attr_reader :object
    # @return [Ittybit::MediaListResponseDataItemFilesItemKind]
    attr_reader :kind
    # @return [String]
    attr_reader :type
    # @return [String]
    ...
    # @return [Integer]
    attr_reader :height
    # @return [Ittybit::MediaListResponseDataItemFilesItemOrientation]
    ...
    # @return [DateTime]
    attr_reader :updated
    # @return [Ittybit::MediaListResponseDataItemFilesItemStatus]
    attr_reader :status
    ...
    # @param id [String]
    # @param object [Ittybit::MediaListResponseDataItemFilesItemObject]
    # @param kind [Ittybit::MediaListResponseDataItemFilesItemKind]
    # @param type [String]
    # @param codec [String]
    # @param container [String]
    # @param width [Integer]
    # @param height [Integer]
    # @param orientation [Ittybit::MediaListResponseDataItemFilesItemOrientation]
    ...
    # @param status [Ittybit::MediaListResponseDataItemFilesItemStatus]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Ittybit::MediaListResponseDataItemFilesItem]
    ...
    # Deserialize a JSON object to an instance of MediaListResponseDataItemFilesItem
    #
    ...
    # Serialize an instance of MediaListResponseDataItemFilesItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.is_a?(Ittybit::MediaListResponseDataItemFilesItemObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
      obj.kind.is_a?(Ittybit::MediaListResponseDataItemFilesItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.orientation&.is_a?(Ittybit::MediaListResponseDataItemFilesItemOrientation) != false || raise("Passed value for field obj.orientation is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::MediaListResponseDataItemFilesItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end
