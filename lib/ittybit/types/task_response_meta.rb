...
require_relative "task_response_meta_type"
require "ostruct"
require "json"
...
module Ittybit
  class TaskResponseMeta
    ...
    # @return [String]
    attr_reader :version
    # @return [Ittybit::TaskResponseMetaType]
    attr_reader :type
    ...
    # @param type [Ittybit::TaskResponseMetaType]
    ...
    # Deserialize a JSON object to an instance of TaskResponseMeta
    #
    ...
    # Serialize an instance of TaskResponseMeta to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(Ittybit::TaskResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
    end
  end
end
