...
module Ittybit
  class FileListResponseLinks
    ...
    # Deserialize a JSON object to an instance of FileListResponseLinks
    #
    ...
    # Serialize an instance of FileListResponseLinks to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
