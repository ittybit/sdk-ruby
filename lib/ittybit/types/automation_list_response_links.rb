...
module Ittybit
  class AutomationListResponseLinks
    # @return [String]
    attr_reader :self_
    # @return [String]
    attr_reader :first
    ...
    # Deserialize a JSON object to an instance of AutomationListResponseLinks
    #
    ...
    # Serialize an instance of AutomationListResponseLinks to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
