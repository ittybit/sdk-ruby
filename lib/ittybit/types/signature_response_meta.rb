...
require_relative "signature_response_meta_type"
require "ostruct"
require "json"

module Ittybit
  class SignatureResponseMeta
    # @return [String]
    ...
    # @return [String]
    attr_reader :version
    # @return [Ittybit::SignatureResponseMetaType]
    attr_reader :type
    ...
    # @param type [Ittybit::SignatureResponseMetaType]
    ...
    # Deserialize a JSON object to an instance of SignatureResponseMeta
    #
    ...
    # Serialize an instance of SignatureResponseMeta to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.type&.is_a?(Ittybit::SignatureResponseMetaType) != false || raise("Passed value for field obj.type is not the expected type, validation failed.")
    end
  end
end
