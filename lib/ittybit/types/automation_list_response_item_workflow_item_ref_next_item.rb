...
module Ittybit
  class AutomationListResponseItemWorkflowItemRefNextItem
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :ref
    ...
    # @return [Ittybit::AutomationListResponseItemWorkflowItemRefNextItem]
    ...
    #  AutomationListResponseItemWorkflowItemRefNextItem
    #
    ...
    # Serialize an instance of AutomationListResponseItemWorkflowItemRefNextItem to a
    #  JSON object
    #
    # @return [String]
    def to_json(*_args)
