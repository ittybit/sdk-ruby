...
module Ittybit
  class AutomationListResponseDataItemTrigger
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :event
    ...
    #  AutomationListResponseDataItemTrigger
    #
    ...
    # Serialize an instance of AutomationListResponseDataItemTrigger to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
