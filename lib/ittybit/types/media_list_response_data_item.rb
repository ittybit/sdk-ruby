...
require_relative "media_list_response_data_item_kind"
require_relative "media_list_response_data_item_files_item"
require "date"
require "ostruct"
require "json"

module Ittybit
  class MediaListResponseDataItem
    # @return [String]
    attr_reader :id
    # @return [String]
    attr_reader :object
    # @return [Ittybit::MediaListResponseDataItemKind]
    attr_reader :kind
    # @return [String]
    attr_reader :title
    # @return [String]
    ...
    # @return [Array<Ittybit::MediaListResponseDataItemFilesItem>]
    attr_reader :files
    ...
    # @param id [String]
    # @param object [String]
    # @param kind [Ittybit::MediaListResponseDataItemKind]
    # @param title [String]
    # @param alt [String]
    # @param width [Integer]
    # @param height [Integer]
    # @param duration [Float]
    # @param files [Array<Ittybit::MediaListResponseDataItemFilesItem>]
    ...
    # @return [Ittybit::MediaListResponseDataItem]
    ...
    # Deserialize a JSON object to an instance of MediaListResponseDataItem
    #
    ...
    def self.from_json(json_object:)
      ...
      files = parsed_json["files"]&.map do |item|
        item = item.to_json
        Ittybit::MediaListResponseDataItemFilesItem.from_json(json_object: item)
      end
    ...
    # Serialize an instance of MediaListResponseDataItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.kind&.is_a?(Ittybit::MediaListResponseDataItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
