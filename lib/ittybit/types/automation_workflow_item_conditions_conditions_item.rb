...
module Ittybit
  class AutomationWorkflowItemConditionsConditionsItem
    # @return [String]
    attr_reader :prop
    # @return [String]
    attr_reader :value
    ...
    # @return [Ittybit::AutomationWorkflowItemConditionsConditionsItem]
    ...
    #  AutomationWorkflowItemConditionsConditionsItem
    #
    ...
    # Serialize an instance of AutomationWorkflowItemConditionsConditionsItem to a
    #  JSON object
    #
    # @return [String]
    def to_json(*_args)
