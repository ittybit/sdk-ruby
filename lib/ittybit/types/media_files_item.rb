...
require_relative "media_files_item_object"
require_relative "media_files_item_kind"
require_relative "media_files_item_orientation"
require "date"
require_relative "media_files_item_status"
require "ostruct"
require "json"

module Ittybit
  class MediaFilesItem
    # @return [String]
    attr_reader :id
    # @return [Ittybit::MediaFilesItemObject]
    attr_reader :object
    # @return [Ittybit::MediaFilesItemKind]
    attr_reader :kind
    # @return [String]
    attr_reader :type
    # @return [String]
    ...
    # @return [Integer]
    attr_reader :height
    # @return [Ittybit::MediaFilesItemOrientation]
    ...
    # @return [DateTime]
    attr_reader :updated
    # @return [Ittybit::MediaFilesItemStatus]
    attr_reader :status
    ...
    # @param id [String]
    # @param object [Ittybit::MediaFilesItemObject]
    # @param kind [Ittybit::MediaFilesItemKind]
    # @param type [String]
    # @param codec [String]
    # @param container [String]
    # @param width [Integer]
    # @param height [Integer]
    # @param orientation [Ittybit::MediaFilesItemOrientation]
    ...
    # @param status [Ittybit::MediaFilesItemStatus]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Ittybit::MediaFilesItem]
    ...
    # Deserialize a JSON object to an instance of MediaFilesItem
    #
    ...
    # Serialize an instance of MediaFilesItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.is_a?(Ittybit::MediaFilesItemObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
      obj.kind.is_a?(Ittybit::MediaFilesItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.orientation&.is_a?(Ittybit::MediaFilesItemOrientation) != false || raise("Passed value for field obj.orientation is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::MediaFilesItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end
