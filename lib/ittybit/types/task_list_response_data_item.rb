...
require_relative "task_list_response_data_item_kind"
require_relative "task_list_response_data_item_status"
require "date"
require_relative "task_list_response_data_item_results"
require "ostruct"
require "json"

module Ittybit
  class TaskListResponseDataItem
    # @return [String]
    attr_reader :id
    # @return [String]
    attr_reader :object
    # @return [Ittybit::TaskListResponseDataItemKind]
    attr_reader :kind
    ...
    # @return [Hash{String => Object}]
    attr_reader :output
    # @return [Ittybit::TaskListResponseDataItemStatus]
    attr_reader :status
    # @return [Integer]
    ...
    # @return [Ittybit::TaskListResponseDataItemResults]
    attr_reader :results
    ...
    # @param id [String]
    # @param object [String]
    # @param kind [Ittybit::TaskListResponseDataItemKind]
    # @param input [Hash{String => Object}]
    # @param options [Hash{String => Object}]
    # @param output [Hash{String => Object}]
    # @param status [Ittybit::TaskListResponseDataItemStatus]
    ...
    # @param results [Ittybit::TaskListResponseDataItemResults]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Ittybit::TaskListResponseDataItem]
    ...
    # Deserialize a JSON object to an instance of TaskListResponseDataItem
    #
    ...
    def self.from_json(json_object:)
      ...
      if parsed_json["results"].nil?
        ...
        results = Ittybit::TaskListResponseDataItemResults.from_json(json_object: results)
      end
      new(
        id: id,
        object: object,
    ...
    # Serialize an instance of TaskListResponseDataItem to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.kind.is_a?(Ittybit::TaskListResponseDataItemKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::TaskListResponseDataItemStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
      ...
      obj.results.nil? || Ittybit::TaskListResponseDataItemResults.validate_raw(obj: obj.results)
    end
  end
end
