...
require_relative "file_response_data_object"
require_relative "file_response_data_kind"
require "date"
require_relative "file_response_data_status"
require "ostruct"
require "json"
...
module Ittybit
  class FileResponseData
    ...
    # @return [Ittybit::FileResponseDataObject]
    attr_reader :object
    # @return [Ittybit::FileResponseDataKind]
    attr_reader :kind
    # @return [String]
    attr_reader :type
    # @return [String]
    ...
    # @return [DateTime]
    attr_reader :updated
    # @return [Ittybit::FileResponseDataStatus]
    attr_reader :status
    ...
    # @param object [Ittybit::FileResponseDataObject]
    # @param kind [Ittybit::FileResponseDataKind]
    # @param type [String]
    # @param codec [String]
    ...
    # @param status [Ittybit::FileResponseDataStatus]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Ittybit::FileResponseData]
    ...
    # Deserialize a JSON object to an instance of FileResponseData
    #
    ...
    # Serialize an instance of FileResponseData to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
    ...
    def self.validate_raw(obj:)
      ...
      obj.object.is_a?(Ittybit::FileResponseDataObject) != false || raise("Passed value for field obj.object is not the expected type, validation failed.")
      obj.kind.is_a?(Ittybit::FileResponseDataKind) != false || raise("Passed value for field obj.kind is not the expected type, validation failed.")
      ...
      obj.status.is_a?(Ittybit::FileResponseDataStatus) != false || raise("Passed value for field obj.status is not the expected type, validation failed.")
    end
  end
end
