...
module Ittybit
  class AutomationResponseDataWorkflowItemRefNextItem
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :ref
    ...
    # @return [Ittybit::AutomationResponseDataWorkflowItemRefNextItem]
    ...
    #  AutomationResponseDataWorkflowItemRefNextItem
    #
    ...
    # Serialize an instance of AutomationResponseDataWorkflowItemRefNextItem to a JSON
    #  object
    #
    # @return [String]
    def to_json(*_args)
