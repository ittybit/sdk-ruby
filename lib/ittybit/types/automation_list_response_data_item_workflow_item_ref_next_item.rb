...
module Ittybit
  class AutomationListResponseDataItemWorkflowItemRefNextItem
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :ref
    ...
    # @return [Ittybit::AutomationListResponseDataItemWorkflowItemRefNextItem]
    ...
    # Serialize an instance of AutomationListResponseDataItemWorkflowItemRefNextItem
    #  to a JSON object
    #
    # @return [String]
    def to_json(*_args)
