...
module Ittybit
  class AutomationResponseTrigger
    # @return [String]
    attr_reader :kind
    # @return [String]
    attr_reader :event
    ...
    # Deserialize a JSON object to an instance of AutomationResponseTrigger
    #
    ...
    # Serialize an instance of AutomationResponseTrigger to a JSON object
    #
    # @return [String]
    def to_json(*_args)
      @_field_set&.to_json
